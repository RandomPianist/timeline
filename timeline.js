	...
	(() => {
		...
		class xe extends he {
			...
			createMedia(t) {
				var e, i, a, s = "",
					...
					o = "",
					r = this;
				n = t.html.split("</p>—")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>—")[1].split('<a href="')[1]).split('">')[0], a = o.split('">')[1].split("</a>")[0], (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") ? (ce("https://platform.twitter.com/widgets.js", (function () {
		...
		class Te extends he {
			...
			createMedia(t) {
				var e, i, a, s = "",
					n = "",
					o = "";
				n = t.html.split("</p>—")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>—")[1].split('<a href="')[1]).split('">')[0], a = o.split('">')[1].split("</a>")[0], n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href');
				let r = this.media_id;
		...
		class Ue {
			...
			getFormattedDate() {
				if (j(this.data.display_date).length > 0) return this.data.display_date;
				var t = "";
				return this.has.title || (this.data.end_date && (t = " — " + this.data.end_date.getDisplayDate(this.getLanguage())), this.data.start_date && (t = this.data.start_date.getDisplayDate(this.getLanguage()) + t)), t
			}
			_initLayout() {
